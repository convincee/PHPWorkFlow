...
/**
 * Base class that represents a row from the 'PHPWF_route' table.
 *
 *
 *
* @package    propel.generator.PHPWorkFlow.DB.Base
*/
abstract class Route implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\PHPWorkFlow\\DB\\Map\\RouteTableMap';
    ...
    /**
     * Initializes internal state of PHPWorkFlow\DB\Base\Route object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\PHPWorkFlow\DB\Route The current object (for fluent API support)
     */
    public function setRouteId($v)
    {
        ...
        if ($this->route_id !== $v) {
            $this->route_id = $v;
            $this->modifiedColumns[RouteTableMap::COL_ROUTE_ID] = true;
        }
    ...
    public function setTransitionId($v)
    {
        ...
        if ($this->transition_id !== $v) {
            ...
            $this->modifiedColumns[RouteTableMap::COL_TRANSITION_ID] = true;
        }
    ...
    public function setRoute($v)
    {
        ...
        if ($this->route !== $v) {
            $this->route = $v;
            $this->modifiedColumns[RouteTableMap::COL_ROUTE] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->created_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[RouteTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setCreatedBy($v)
    {
        ...
        if ($this->created_by !== $v) {
            $this->created_by = $v;
            $this->modifiedColumns[RouteTableMap::COL_CREATED_BY] = true;
        }
    ...
    public function setModifiedAt($v)
    {
        ...
        if ($this->modified_at !== null || $dt !== null) {
            if ($this->modified_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->modified_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[RouteTableMap::COL_MODIFIED_AT] = true;
            }
        } // if either are not null
    ...
    public function setModifiedBy($v)
    {
        ...
        if ($this->modified_by !== $v) {
            $this->modified_by = $v;
            $this->modifiedColumns[RouteTableMap::COL_MODIFIED_BY] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : RouteTableMap::translateFieldName('RouteId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->route_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : RouteTableMap::translateFieldName('TransitionId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->transition_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : RouteTableMap::translateFieldName('Route', TableMap::TYPE_PHPNAME, $indexType)];
            $this->route = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : RouteTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : RouteTableMap::translateFieldName('CreatedBy', TableMap::TYPE_PHPNAME, $indexType)];
            $this->created_by = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : RouteTableMap::translateFieldName('ModifiedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->modified_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : RouteTableMap::translateFieldName('ModifiedBy', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 7; // 7 = RouteTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\PHPWorkFlow\\DB\\Route'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if (null !== $this->route_id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . RouteTableMap::COL_ROUTE_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(RouteTableMap::COL_ROUTE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'route_id';
        }
        if ($this->isColumnModified(RouteTableMap::COL_TRANSITION_ID)) {
            $modifiedColumns[':p' . $index++]  = 'transition_id';
        }
        if ($this->isColumnModified(RouteTableMap::COL_ROUTE)) {
            $modifiedColumns[':p' . $index++]  = 'route';
        }
        if ($this->isColumnModified(RouteTableMap::COL_CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'created_at';
        }
        if ($this->isColumnModified(RouteTableMap::COL_CREATED_BY)) {
            $modifiedColumns[':p' . $index++]  = 'created_by';
        }
        if ($this->isColumnModified(RouteTableMap::COL_MODIFIED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'modified_at';
        }
        if ($this->isColumnModified(RouteTableMap::COL_MODIFIED_BY)) {
            $modifiedColumns[':p' . $index++]  = 'modified_by';
        }

        $sql = sprintf(
            'INSERT INTO PHPWF_route (%s) VALUES (%s)',
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\PHPWorkFlow\DB\Route
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setRouteId($arr[$keys[0]]);
        }
        if (array_key_exists($keys[1], $arr)) {
            $this->setTransitionId($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setRoute($arr[$keys[2]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\PHPWorkFlow\DB\Route The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(RouteTableMap::COL_ROUTE_ID)) {
            $criteria->add(RouteTableMap::COL_ROUTE_ID, $this->route_id);
        }
        if ($this->isColumnModified(RouteTableMap::COL_TRANSITION_ID)) {
            $criteria->add(RouteTableMap::COL_TRANSITION_ID, $this->transition_id);
        }
        if ($this->isColumnModified(RouteTableMap::COL_ROUTE)) {
            $criteria->add(RouteTableMap::COL_ROUTE, $this->route);
        }
        if ($this->isColumnModified(RouteTableMap::COL_CREATED_AT)) {
            $criteria->add(RouteTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(RouteTableMap::COL_CREATED_BY)) {
            $criteria->add(RouteTableMap::COL_CREATED_BY, $this->created_by);
        }
        if ($this->isColumnModified(RouteTableMap::COL_MODIFIED_AT)) {
            $criteria->add(RouteTableMap::COL_MODIFIED_AT, $this->modified_at);
        }
        if ($this->isColumnModified(RouteTableMap::COL_MODIFIED_BY)) {
            $criteria->add(RouteTableMap::COL_MODIFIED_BY, $this->modified_by);
        }
    ...
    /**
     * Generic method to set the primary key (route_id column).
     *
     ...
     * objects.
     *
     * @param      object $copyObj An object of \PHPWorkFlow\DB\Route (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setRouteId(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \PHPWorkFlow\DB\Route Clone of current object.
     * @throws PropelException
     */
    ...
    public function getTransition(ConnectionInterface $con = null)
    {
        if ($this->aTransition === null && ($this->transition_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aTransition->addRoutes($this);
             */
        }
    ...
    {
        if (null !== $this->aTransition) {
            $this->aTransition->removeRoute($this);
        }
        $this->route_id = null;
