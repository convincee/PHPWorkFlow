...
/**
 * Base class that represents a row from the 'PHPWF_notification' table.
 *
 *
 *
...
abstract class Notification implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\PHPWorkFlow\\DB\\Map\\NotificationTableMap';
    ...
    /**
     * The value for the notification_string field.
     *
     * @var        string
     */
    protected $notification_string;
    ...
    /**
     * Initializes internal state of PHPWorkFlow\DB\Base\Notification object.
     * @see applyDefaults()
     */
    ...
    /**
     * Get the [notification_string] column value.
     *
     * @return string
     */
    public function getNotificationString()
    {
     ...
     * @return $this|\PHPWorkFlow\DB\Notification The current object (for fluent API support)
     */
    public function setNotificationId($v)
    {
        ...
        if ($this->notification_id !== $v) {
            ...
            $this->modifiedColumns[NotificationTableMap::COL_NOTIFICATION_ID] = true;
        }
    ...
    public function setTransitionId($v)
    {
        ...
        if ($this->transition_id !== $v) {
            ...
            $this->modifiedColumns[NotificationTableMap::COL_TRANSITION_ID] = true;
        }
    ...
    public function setNotificationType($v)
    {
        ...
        if ($this->notification_type !== $v) {
            ...
            $this->modifiedColumns[NotificationTableMap::COL_NOTIFICATION_TYPE] = true;
        }
    ...
    /**
     * Set the value of [notification_string] column.
     *
     * @param string $v new value
     * @return $this|\PHPWorkFlow\DB\Notification The current object (for fluent API support)
     */
    public function setNotificationString($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->notification_string !== $v) {
            $this->notification_string = $v;
            $this->modifiedColumns[NotificationTableMap::COL_NOTIFICATION_STRING] = true;
        }
    ...
    public function setCreatedBy($v)
    {
        ...
        if ($this->created_by !== $v) {
            $this->created_by = $v;
            $this->modifiedColumns[NotificationTableMap::COL_CREATED_BY] = true;
        }
    ...
    public function setModifiedAt($v)
    {
        ...
        if ($this->modified_at !== null || $dt !== null) {
            if ($this->modified_at === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->modified_at->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[NotificationTableMap::COL_MODIFIED_AT] = true;
            }
        } // if either are not null
    ...
    public function setModifiedBy($v)
    {
        ...
        if ($this->modified_by !== $v) {
            $this->modified_by = $v;
            $this->modifiedColumns[NotificationTableMap::COL_MODIFIED_BY] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : NotificationTableMap::translateFieldName('NotificationId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->notification_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : NotificationTableMap::translateFieldName('TransitionId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->transition_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : NotificationTableMap::translateFieldName('NotificationType', TableMap::TYPE_PHPNAME, $indexType)];
            $this->notification_type = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : NotificationTableMap::translateFieldName('NotificationString', TableMap::TYPE_PHPNAME, $indexType)];
            $this->notification_string = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : NotificationTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : NotificationTableMap::translateFieldName('CreatedBy', TableMap::TYPE_PHPNAME, $indexType)];
            $this->created_by = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : NotificationTableMap::translateFieldName('ModifiedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->modified_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : NotificationTableMap::translateFieldName('ModifiedBy', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\PHPWorkFlow\\DB\\Notification'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(NotificationTableMap::COL_NOTIFICATION_ID)) {
            $modifiedColumns[':p' . $index++]  = 'notification_id';
        }
        if ($this->isColumnModified(NotificationTableMap::COL_TRANSITION_ID)) {
            $modifiedColumns[':p' . $index++]  = 'transition_id';
        }
        if ($this->isColumnModified(NotificationTableMap::COL_NOTIFICATION_TYPE)) {
            $modifiedColumns[':p' . $index++]  = 'notification_type';
        }
        if ($this->isColumnModified(NotificationTableMap::COL_NOTIFICATION_STRING)) {
            $modifiedColumns[':p' . $index++]  = 'notification_string';
        }
        if ($this->isColumnModified(NotificationTableMap::COL_CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'created_at';
        }
        if ($this->isColumnModified(NotificationTableMap::COL_CREATED_BY)) {
            $modifiedColumns[':p' . $index++]  = 'created_by';
        }
        if ($this->isColumnModified(NotificationTableMap::COL_MODIFIED_AT)) {
            $modifiedColumns[':p' . $index++]  = 'modified_at';
        }
        if ($this->isColumnModified(NotificationTableMap::COL_MODIFIED_BY)) {
            $modifiedColumns[':p' . $index++]  = 'modified_by';
        }

        $sql = sprintf(
            'INSERT INTO PHPWF_notification (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'notification_type':
                        ...
                        break;
                    case 'notification_string':
                        $stmt->bindValue($identifier, $this->notification_string, PDO::PARAM_STR);
                        break;
                    case 'created_at':
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            ...
            case 2:
                ...
                break;
            case 3:
                return $this->getNotificationString();
                break;
            case 4:
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[3] => $this->getNotificationString(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\PHPWorkFlow\DB\Notification
     */
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 2:
                ...
                break;
            case 3:
                $this->setNotificationString($value);
                break;
            case 4:
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) {
            $this->setNotificationString($arr[$keys[3]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\PHPWorkFlow\DB\Notification The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(NotificationTableMap::COL_NOTIFICATION_ID)) {
            $criteria->add(NotificationTableMap::COL_NOTIFICATION_ID, $this->notification_id);
        }
        if ($this->isColumnModified(NotificationTableMap::COL_TRANSITION_ID)) {
            $criteria->add(NotificationTableMap::COL_TRANSITION_ID, $this->transition_id);
        }
        if ($this->isColumnModified(NotificationTableMap::COL_NOTIFICATION_TYPE)) {
            $criteria->add(NotificationTableMap::COL_NOTIFICATION_TYPE, $this->notification_type);
        }
        if ($this->isColumnModified(NotificationTableMap::COL_NOTIFICATION_STRING)) {
            $criteria->add(NotificationTableMap::COL_NOTIFICATION_STRING, $this->notification_string);
        }
        if ($this->isColumnModified(NotificationTableMap::COL_CREATED_AT)) {
            $criteria->add(NotificationTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(NotificationTableMap::COL_CREATED_BY)) {
            $criteria->add(NotificationTableMap::COL_CREATED_BY, $this->created_by);
        }
        if ($this->isColumnModified(NotificationTableMap::COL_MODIFIED_AT)) {
            $criteria->add(NotificationTableMap::COL_MODIFIED_AT, $this->modified_at);
        }
        if ($this->isColumnModified(NotificationTableMap::COL_MODIFIED_BY)) {
            $criteria->add(NotificationTableMap::COL_MODIFIED_BY, $this->modified_by);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \PHPWorkFlow\DB\Notification (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setNotificationString($this->getNotificationString());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \PHPWorkFlow\DB\Notification Clone of current object.
     * @throws PropelException
     */
    ...
    public function getTransition(ConnectionInterface $con = null)
    {
        if ($this->aTransition === null && ($this->transition_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aTransition->addNotifications($this);
             */
        }
    ...
    {
        if (null !== $this->aTransition) {
            $this->aTransition->removeNotification($this);
        }
        $this->notification_id = null;
        $this->transition_id = null;
        $this->notification_type = null;
        $this->notification_string = null;
