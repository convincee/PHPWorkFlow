 ...
 * @codeCoverageIgnore
 */
class TriggersShortCutTest extends PHPWorkFlow_Framework_TestCase_Integration
{
    /**
     ...
     */
    public function testTriggersShortCut(PHPWorkFlow\DB\WorkFlow $workFlowObj)
    {
        $useCaseObj = $this->getWorkFlowDAO()->CreateUseCase(
            [
                'WorkFlowId'    => $workFlowObj->getWorkFlowId(),
                'Name'          => 'Test work flow - testTriggersShortCut',
                'Description'   => 'Test work flow - testTriggersShortCut',
